...
- `all`: Move `cmd/schemagen` to opentelemetry-collector as `go.opentelemetry.io/collector/cmd/schemagen`. ([#14543](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/14543))
