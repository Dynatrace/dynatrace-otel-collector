...
func TestFunctionalityDownloadFileHTTPS(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.testName, func(t *testing.T) {
			fp := newConfigurableHTTPProvider(EECScheme, confmaptest.NewNopProviderSettings())
...
func TestValidateProviderScheme(t *testing.T) {
	assert.NoError(t, confmaptest.ValidateProviderScheme(New(EECIScheme, confmaptest.NewNopProviderSettings())))
}
