...
```shell
./data-ingest --input-file=./commands/zipkin/testdata/sample_v1.json --input-format=zipkin --otlp-signal-type=traces --collector-url=http://0.0.0.0:9411 --output-file=received_traces.json --receiver-port=4319 --receiver-type=http
```
