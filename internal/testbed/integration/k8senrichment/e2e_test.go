...
// TestEnrichFromKubernetes tests the "Enrich from Kubernetes" use case
// See: https://docs.dynatrace.com/docs/shortlink/otel-collector-cases-k8s-enrich
func TestEnrichFromKubernetes(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			attrs: map[string]oteltest.ExpectedValue{
				...
				"dt.cost.costcenter":                       oteltest.NewExpectedValue(oteltest.AttributeMatchTypeEqual, "costcenter_test"),
				"dt.cost.product":                          oteltest.NewExpectedValue(oteltest.AttributeMatchTypeEqual, "costprdct_test"),
				"dt.security_context":                      oteltest.NewExpectedValue(oteltest.AttributeMatchTypeEqual, "secctxt_test"),
				"k8s.namespace.annotation.myAnnotationKey": oteltest.NewExpectedValue(oteltest.AttributeMatchTypeEqual, "custom_test"),
			},
		},
		{
