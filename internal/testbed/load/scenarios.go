...
// Scenario70kItemsPerSecond runs 80k data items/sec test using specified sender and receiver protocols.
...
// The only difference from Scenario80kItemsPerSecond is that this method can be used to specify a different backend. This
